...
-file("/home/adgear/code/otp/bootstrap/lib/parsetools/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
%% yeccpars2_428: see yeccpars2_345
...
yeccgoto_add_op(324, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_345(427, Cat, Ss, Stack, T, Ts, Tzr);
...
yeccgoto_mult_op(323, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_345(431, Cat, Ss, Stack, T, Ts, Tzr);
...
yeccpars2_400_(__Stack0) ->
 [__1 | __Stack] = __Stack0,
 [begin
   [ { type , ? anno ( __1 ) , map_field_assoc ,
    [ { type , ? anno ( __1 ) , any , [ ] } ,
    { type , ? anno ( __1 ) , any , [ ] } ] } ]
  end | __Stack].

-file("erl_parse.erl", 10211).
